...
def getPoPath():
    import Products
    product_file = getattr(Products, 'CPSDocument').__file__
...
class TestPOT(CPSDocumentTestCase.CPSDocumentTestCase):
    potFile = None
...
class TestPoFile(CPSDocumentTestCase.CPSDocumentTestCase):
    poFile = None
...
class TestMsg(CPSDocumentTestCase.CPSDocumentTestCase):
    poFile = None
    potFile = None
