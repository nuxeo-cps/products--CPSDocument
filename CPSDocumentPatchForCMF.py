...
"""'stock' CMF Patch on CPSDocument

Here stands a patch for CPSDocument which is on ProxyBase within CPSCore
Thus it has to be on the document itself within CMF
"""
...
from CPSDocument import CPSDocument
...
CPSDocument.__getitem__ = __getitem__
